          ...
          <Stack direction="column" justifyContent="center">
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" pb={2} mx={5}>
              ...
              <Button variant="contained" onClick={onSubmitHandler}>
                {is600px ? <SaveAsOutlinedIcon /> : 'Хадгалах'}
              </Button>
            </Stack>
            <Divider />
            {/*=========== ADD INFOs========== */}
            <Stack direction={is600px | between600_900 ? 'column' : 'row'} mb={10}>
              ...
              <Box className={styles.inputs} mx={10}>
                <Stack direction="column">
                  ...
                  <TextField placeholder="Энд бичнэ үү" name="name" onChange={inputHandler} />
                  <Typography variant="font16Bold600" color="secondary.black" mt={5} mb={2}>
                    Дэлгэрэнгүй
                  </Typography>
                  <TextField variant="outlined" placeholder="Энд бичнэ үү" name="desription" onChange={inputHandler} />
                </Stack>
                <Stack direction="row">
                  <Stack mr={5} sx={{ minWidth: 200 }}>
                    ...
                    <TextField type="number" placeholder="₮ Энд бичнэ үү" name="price" onChange={inputHandler} />
                  </Stack>
                  <Stack>
                    <Typography variant="font16Bold600" color="secondary.black" mt={5} mb={2}>
                      Төрөл
                    ...
                    <FormControl sx={{ minWidth: 200 }}>
                      ...
                      <Select value={addedFood.category} name="category" onChange={inputHandler}>
                        ...
                        <MenuItem value={'Цавуулаггүй хоол'}>Цавуулаггүй хоол</MenuItem>
                        <MenuItem value={'Хөнгөн хоол'}>Хөнгөн хоол</MenuItem>
                        <MenuItem value={'Халуун ногоотой хоол'}>Халуун ногоотой хоол</MenuItem>
                ...
                <Stack direction="column">
                  ...
                  <TextField type="number" placeholder="Энд бичнэ үү" name="portion" onChange={inputHandler} />
                </Stack>
              </Box>
            </Stack>
            <Divider />
